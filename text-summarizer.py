...
def main():
	try:
		...
		#print(preprocessed_text[2]['kolja'].term_weight)
		print('keyword_feature')
		print(keyword_feature_value)
		print('title_word_feature')
		print(title_word_feature_value)
		print('sentence_location_feature')
		print(sentence_location_feature_value)
		print('sentence_length_feature')
		print(sentence_length_feature_value)
		print('proper_noun_feature')
		print(proper_noun_feature_value)
		print('cue_phrase_feature')
		print(cue_phrase_feature_value)
		print('stigma_phrase_feature')
		print(stigma_phrase_feature_value)
		print('numerical_data_feature')
		print(numerical_data_feature_value)
